(function (root, factory) {
    ...
    templatizer["body"] = function tmpl_body() {
        return '<body><nav class="navbar navbar-default"><div class="container-fluid"><div class="navbar-header"><a href="/" class="navbar-brand">Ampersand</a></div><ul class="nav navbar-nav"><li><a href="/">home</a></li><li><a href="/collections">collection demo</a></li><li><a href="/info">more info</a></li><li><a href="/clients">Clients</a></li><li><a href="/customers">Customers</a></li><li><a href="/moonBoots">Moonboots!</a></li></ul></div></nav></body><div class="container"><main data-hook="page-container"></main></div>';
    };
    ...
    // pages/clients.jade compiled template
    templatizer["pages"]["clients"] = function tmpl_pages_clients() {
        return '<section class="page pageFour"><h2>Clients Page</h2><p>This page was rendered by a simple page view file at client/pages/clients.js.</p><p>Written with love by Steve.</p></section>';
    };
    ...
    // pages/customers.jade compiled template
    templatizer["pages"]["customers"] = function tmpl_pages_customers() {
        return '<section class="page pageThree"><h2>Customers Page</h2><p>This page was rendered by a simple page view file at client/views/customer.js.</p><p>Written with love by Steve.</p></section>';
    };
    ...
    // pages/moonBoots.jade compiled template
    templatizer["pages"]["moonBoots"] = function tmpl_pages_moonBoots() {
        return '<section class="page pageFour"><h2>MoonBoots!</h2><p>This page was rendered by a simple page view file at client/pages/moonBoots.js.</p><p>Written with love by Steve.</p></section>';
    };
